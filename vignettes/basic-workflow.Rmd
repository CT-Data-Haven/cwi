...
```{r quick_map1, out.width="100%"}
tenure_map <- homeownership %>%
  filter(level == "4_town") %>%
  quick_map(
    value = share, level = "town", color = "black", size = 0.4,
...
```{r quick_map2, message=FALSE, warning=FALSE, out.width="100%"}
tenure_map +
