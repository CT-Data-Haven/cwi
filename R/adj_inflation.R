...
#' @param base_year Year on which to base inflation amounts. Defaults to 2019, which corresponds to saying "... adjusted to 2019 dollars."
...
#' }
#' @export
adj_inflation <- function(data, value, year, base_year = 2019, verbose = TRUE, key = NULL) {
