# TODO: move to dcws
wts <- dcws::read_weights(system.file("extdata/test_xtab2015.xlsx", package = "cwi")) |>
...
cws_demo <- dcws::read_xtabs(system.file("extdata/test_xtab2015.xlsx", package = "cwi"), year = 2015, process = TRUE) |>
